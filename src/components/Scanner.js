...
const Scanner = ({
    ...
    const handleProcessed = (result) => {
        ...
        if (result) {
            ...
            if (result.codeResult && result.codeResult.code) {
                ...
                fetch(`https://world.openfoodfacts.org/api/v1/product/${result.codeResult.code}.json`)
                    // fetch(`https://world.openfoodfacts.org/api/v1/product/9414942110917.json`)
                    .then(res => res.json())
    ...
    const onInfoFetched = (res) => {
        ...
        if (status === 1) {
            Quagga.stop();
            console.log("OpenfooFacts API result ::: ", res);
            if (res.product.origins == "New Zealand") {
                alert("All Good mate!");
            }
            ...
            console.warn("Not found in openfoodfacts Database");
            alert("I don't know yet sorry :-(")
        }
    }
